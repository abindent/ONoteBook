...
const Main = () => {
    ...
    <div className="col-lg-6 mx-auto">
      <p className="lead mb-4">Quickly save your <Journal />&nbsp;notes on on the <Cloud />&nbsp;cloud, <PencilSquare />&nbsp;update and  <Trash />&nbsp;delete your notes online, with this powerfull tool O-NoteBook.</p>
